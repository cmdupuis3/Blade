...
let test_partial_product_symmetry_distinct = """
type Lat = Idx<3>
...
let functionTests = [
    ("Partial Product Symmetry Distinct Arrays", test_partial_product_symmetry_distinct)
