...
(* diagonal_swap_is_symmetry into the tower; composite indices are       *)
(* opaque values here, so nothing depends on their encoding.             *)
(* ===================================================================== *)
...
(* ===================================================================== *)
(* Notes:                                                                *)
(*  - Exactness (uniform license = kernel invariance intersected with    *)
(*    binding stabilizer, both directions) is BladeCompleteness.v.       *)
(*  - The diagonal instance for multi-dimensional identity groups is     *)
(*    diagonal_group_law above.                                          *)
(*  - Sign-tracked antisymmetric lowering is the AntisymmetricLowering   *)
(*    section above; Hermitian is the same construction with negation    *)
(*    replaced by conjugation and is not mechanized.                     *)
(* ===================================================================== *)
