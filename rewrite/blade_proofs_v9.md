...
- [2. Computational Paradigms: S/T and T/S](#computational-paradigms-st-and-ts)
    ...
    - [2.10 Syntactic Impossibility Theorems](#syntactic-impossibility-theorems)
    - [2.11 The Necessity Theorems](#the-necessity-theorems)
- [9. Loop Objects](#loop-objects)
    - [9.6 Structural Trinity Proofs](#structural-trinity-proofs)
    - [9.7 Symmetry Lowering Theorems](#symmetry-lowering-theorems)
    - [9.8 Uniqueness Theorems](#uniqueness-theorems)
- [10. Arity Polymorphism](#arity-polymorphism)
    - [10.3 Variadic vs Arity Polymorphism Theorems](#variadic-vs-arity-polymorphism-theorems)
- [12. Combinator Algebra](#combinator-algebra)
    - [12.6 The Duality Theorem](#the-duality-theorem)
    - [12.7 Rank-0 Convergence Theorem](#rank-0-convergence-theorem)
...
- [20. Conclusion](#conclusion)
    - [20.1 Necessity and Uniqueness Theorem](#necessity-and-uniqueness-theorem)
