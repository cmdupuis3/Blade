...
(*                                                                       *)
(* Backs the AD plan (plan-forward-mode-ad-and-nn-module.md sect. 3.3    *)
(* consequence 2, sect. 6.4/6.5 symmetric bullets, stage C5) and the     *)
(* future.md sect. 2.1 open items "Jacobian symmetry theorem" and        *)
(* "symmetric gradient accumulation".                                    *)
(*                                                                       *)
(* Sections:                                                             *)
