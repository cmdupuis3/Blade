...
(*      STRICTLY smaller than S_{2r}: the sound joint form for a comm-    *)
(*      repeated symmetric argument is the wreath product, NOT S_{2r},    *)
(*      and s4_orbit_not_licensed is the refutation of the S_{2r}         *)
(*      reading.  See docs/plan-orbit-index-types.md.                     *)
(*                                                                       *)
...
(* values.  The sound joint form for a comm-repeated symmetric argument   *)
(* is the wreath product, not S_{2r} (docs/plan-orbit-index-types.md).    *)
(* ===================================================================== *)
